...
# main_card = dbc.Card([
#         html.H3("Peta Upah Minimum Provinsi", style={"width":"100%", "height":"20%",  "text-align":"center", "font-family":"Futura", "font-size":"18px"}),
#         dbc.CardBody([dbc.CardHeader([html.Label("Pilih Tahun UMP:"),dropdown], style={"width":"30%", "height":"5%", "text-align":"left", "font-family":"Futura", "font-size":"12px", "background-color":"rgba(17, 17, 17, 1)"}),
#                         map_graph, line_graph2], style={"width":"100%", "height":"100%"}),
...
# support_card = dbc.Card([
#         # dbc.CardHeader([
#         #         html.Label("Pilih Provinsi:"),
#         #         dropdown2
#         # ], style={"width":"40%", "height":"20%", "text-align":"left", "font-family":"Futura", "font-size":"12px"}),
#         dbc.CardBody([dbc.CardHeader([html.Label("Pilih Provinsi:"), dropdown2], style={"width":"35%", "height":"20%", "text-align":"left", "font-family":"Futura", 
#                                                                                         "font-size":"12px", "background-color":"rgba(17, 17, 17, 1)", "border":"0px rgba(17, 17, 17, 1)"}), 
#                                         line_graph1, treemap_graph], style={"width":"100%", "height":"30%"}),
#         # dbc.CardBody(treemap_graph, style={"width":"100%", "height":"60%", "font-family":"Futura"})
# ], style={"background-color":"rgba(17, 17, 17, 1)", "border":"0px rgba(17, 17, 17, 1)"})
...
def minimum_wage_map(selected_year, hover_data):
        ...
        # line2_fig = px.line(
        #         dff1, x='Tahun', y='KenaikanUpah'
        #         )

        ## update figure layout
        # line2_fig.update_layout(template='plotly_dark')
        # line2_fig.update_traces(line=dict(color='steelblue'))
        # line2_fig.update_layout(yaxis=dict(tickformat=',.0f', tickprefix='Rp ', title=''))
        # # line2_fig.update_layout(xaxis=dict(showgrid=False))
        # line2_fig.update_layout(autosize=False,width=850,height=275)
        # line2_fig.update_layout(
        #         title=f'<b>Jumlah Kenaikan UMP Tahunan Provinsi {prov_name}</b>',
        #         title_x=0.5, title_y=0.9, title_font_size=16
        #         )
        # line2_fig.update_layout(font=dict(family='Futura'))
